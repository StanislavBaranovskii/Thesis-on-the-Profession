...
Каталог `yc_cli` содержит остальные файлы bash скриптов, которые выполняют создание/конфигурирование отдельных ВМ, и создание отдельных специализированных облачных сервисов. Запускаются на выполнение в основном стартовом bash скрипте. Так же написаны с использованием интерфейса команд YC CLI.
